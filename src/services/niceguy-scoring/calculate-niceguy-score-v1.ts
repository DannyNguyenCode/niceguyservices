import { NICEGUY_SCORING_VERSION_V1 } from "@/src/config/niceguy-scoring";
...
/** @deprecated Use calculateNiceGuyScoreV2 for new audits. Preserved for niceguy-v1 records. */
export function calculateNiceGuyScoreV1(input: NiceGuyScoringInput): NiceGuyScoreResult {
    ...
    return {
        scoringVersion: NICEGUY_SCORING_VERSION_V1,
        overallScore,
        categories,
        summary,
    };
