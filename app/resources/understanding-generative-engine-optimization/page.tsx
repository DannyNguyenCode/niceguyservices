...
import { createArticleMetadata } from "@/components/resources/digital-craftsman/createArticleRoute";
    ...
    return (
        <>
            ...
            <ResourceArticleSupplementalJsonLd
                ...
                faq={GEO_FAQ_SCHEMA}
            />
            <DigitalCraftsmanArticlePage meta={geoMeta}>
                <GeoArticleContent meta={geoMeta} />
