...
import { approveDemoAsset, rejectDemoAsset } from "@/src/data/demo-assets";
...
export async function POST(_request: Request, context: RouteContext) {
    ...
    const asset = await approveDemoAsset(assetId);
    if (!asset) {
    ...
    if (project) {
        await createActivityLog({
            ...
            type: "demo-asset-approved",
            description: "Demo asset approved.",
