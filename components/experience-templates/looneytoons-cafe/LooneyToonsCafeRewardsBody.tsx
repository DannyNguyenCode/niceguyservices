        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <div className="relative mb-12 w-full max-w-lg -rotate-1 rounded-xl border-4 border-[#151c28] bg-[#f9f9ff] p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div className="mb-2 flex items-end justify-between">
              ...
              <span className="pb-2 text-sm font-bold [font-family:var(--font-lt-space),system-ui,sans-serif]">STARS EARNED</span>
            </div>
            <div className="relative h-8 w-full overflow-hidden rounded-full border-4 border-[#151c28] bg-[#dde2f4]">
              <div className="relative h-full w-[31%] border-r-4 border-[#151c28] bg-[#d4daec]">
                <div className="lt-halftone-light absolute inset-0 opacity-30" aria-hidden />
              </div>
            </div>
            <p className="mt-4 italic text-[#444748] [font-family:var(--font-lt-space),system-ui,sans-serif]">1 star for every $1 spent</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#e2e8fa] px-4 py-20 md:px-16">
        <div className="mx-auto grid max-w-[1280px] items-center gap-12 md:grid-cols-2">
          <div className="space-y-8">
            ...
            <form className="max-w-sm space-y-4" aria-label="Rewards enrollment (demo)">
              <input
                className="w-full rounded-xl border-4 border-[#151c28] bg-[#f9f9ff] p-4 text-sm font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] placeholder:opacity-50 focus:border-[#151c28] focus:ring-0 focus:outline-none [font-family:var(--font-lt-space),system-ui,sans-serif]"
              ...
              <button
                type="button"
                className="w-full rounded-full border-4 border-[#151c28] bg-[#151c28] py-4 text-base font-bold text-[#f9f9ff] shadow-[4px_4px_0px_0px_rgba(212,218,236,1)] transition-all hover:scale-[0.98] active:translate-y-1 [font-family:var(--font-lt-space),system-ui,sans-serif]"
              >
                Enroll now
              </button>
            </form>
