...
export function ValleyInterlockingPorchBuildGuideBody() {
  useViNavScroll();
      ...
      <ViContainer className="py-[var(--vi-stack-md)] lg:py-[var(--vi-stack-lg)]">
        ...
        <div className="grid grid-cols-1 gap-[var(--vi-gutter)] lg:grid-cols-12">
          <article className="space-y-[var(--vi-stack-md)] lg:col-span-8 lg:pr-12">
            <section id={article.purpose.id} className="scroll-mt-28">
              <SectionHeading number={article.purpose.number} title={article.purpose.title} />
              <p className="vi-body-md leading-relaxed text-[var(--vi-on-surface-variant)]">{article.purpose.body}</p>
            </section>
            ...
            <div className="grid grid-cols-1 gap-[var(--vi-gutter)] md:grid-cols-2">
              ...
              <section
                id={article.seasonalCard.id}
                className="scroll-mt-28 border border-[color-mix(in_srgb,var(--vi-outline-variant)_20%,transparent)] bg-[var(--vi-surface-container-lowest)] p-8"
              >
                <h3 className="vi-headline-sm mb-4 text-[var(--vi-on-surface)]">{article.seasonalCard.title}</h3>
                <p className="vi-body-md text-[var(--vi-on-surface-variant)]">{article.seasonalCard.body}</p>
              </section>
            </div>
            ...
            >
              <h2 className="vi-headline-md mb-4 text-white">{article.permits.title}</h2>
